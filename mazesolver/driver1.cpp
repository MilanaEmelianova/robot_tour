...
// fix find path options
// get rid of the user input
// store the velocity in a variable
// count the number of turns and set the velocity for them too
// calculate the distance (and create the variable for time)
// watch the tutorial for programming the motors in youtube
// come up with the way to do all the thigs in one programm (input maze, get the velocity value and teh sequence of turns)
// DONE create .txt in c++
